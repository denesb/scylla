...
public:
    ...
    database(const db::config&, database_config dbcfg, logalloc::tracker& tracker, service::migration_notifier& mn, gms::feature_service& feat, const locator::shared_token_metadata& stm,
    ...
    logalloc::tracker& logalloc_tracker() const { return _tracker; }
