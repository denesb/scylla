...
future<foreign_ptr<lw_shared_ptr<query::result>>> dump_mutations(
    ...
    auto compaction_state = make_lw_shared<compact_for_query_state>(*output_schema, qs.cmd.timestamp, qs.cmd.slice, qs.remaining_rows(), qs.remaining_partitions(), tombstone_gc_before_getter{});
