...
database::database(const db::config& cfg, database_config dbcfg, logalloc::tracker& tracker, service::migration_notifier& mn, gms::feature_service& feat, const locator::shared_token_metadata& stm,
