...
class scylla_reads(gdb.Command):
    """List all active reads on the shard for the given semaphores.

    The command accepts multiple semaphores as arguments to list reads
    ...
    def invoke(self, args, from_tty):
        ...
        for semaphore in semaphores:
            scylla_reads.dump_reads_from_semaphore(semaphore)
