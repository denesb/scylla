...
SEASTAR_THREAD_TEST_CASE(test_partition_based_splitting_mutation_writer) {
    ...
    mutation_writer::segregate_by_partition(flat_mutation_reader_from_mutations(tests::make_permit(), std::move(input_mutations)), 10000, [] (flat_mutation_reader rd) {
...
SEASTAR_THREAD_TEST_CASE(test_partition_based_splitting_mutation_writer_bucket_limit) {
    ...
    mutation_writer::segregate_by_partition(flat_mutation_reader_from_mutations(tests::make_permit(), std::move(input_mutations)), max_buckets,
