...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , reader_concurrency_semaphore_oom_kill_limit_multiplier_threshold(this, "reader_concurrency_semaphore_oom_kill_limit_multiplier_threshold", liveness::LiveUpdate, value_status::Used, 3,
