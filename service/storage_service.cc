...
void storage_service::join_token_ring(int delay) {
    ...
    cdc::maybe_rewrite_streams_descriptions(
            ...
            [ss = this->shared_from_this()] { return ss->get_token_metadata().count_normal_token_owners(); },
            _abort_source);
...
future<> storage_service::restore_replica_count(inet_address endpoint, inet_address notify_endpoint) {
  ...
  return seastar::async([this, endpoint, notify_endpoint] {
    ...
    auto streamer = make_lw_shared<dht::range_streamer>(_db, get_token_metadata(), as, get_broadcast_address(), "Restore_replica_count", streaming::stream_reason::removenode);
