...
partition_slice legacy_reverse_slice_to_native_reverse_slice(partition_slice slice) {
...
partition_slice native_reverse_slice_to_legacy_reverse_slice(partition_slice slice) {
    // They are the same, we give them different names to express intent
    return legacy_reverse_slice_to_native_reverse_slice(slice);
}

partition_slice reverse_slice(partition_slice slice) {
    ...
    slice.options.set(partition_slice::option::reversed);
