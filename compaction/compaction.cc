...
private:
    ...
    max_purgeable_fn max_purgeable_func() {
        ...
        return [this] (const dht::decorated_key& dk, is_shadowable is_shadowable) {
            return get_max_purgeable_timestamp(_table_s, *_selector, _compacting_for_max_purgeable_func, dk, _bloom_filter_checks, _compacting_max_timestamp, _tombstone_gc_state.is_commitlog_check_disabled(), is_shadowable);
        };
    }
